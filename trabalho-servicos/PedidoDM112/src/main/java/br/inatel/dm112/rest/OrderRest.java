...
public class OrderRest implements OrderInterface {
	...
	@Override
	@PutMapping("/orders/{orderNumber}/shipped")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void startOrderDelivery(@PathVariable("orderNumber") Integer orderNumber) {

		System.out.println("OrderRest - startOrderDelivery " + orderNumber);
		service.startDelivery(orderNumber);
	}

	@Override
	@PutMapping("/orders/{orderNumber}/delivered")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void confirmOrderDelivery(@PathVariable("orderNumber") Integer orderNumber) {

		System.out.println("OrderRest - confirmOrderDelivery " + orderNumber);
